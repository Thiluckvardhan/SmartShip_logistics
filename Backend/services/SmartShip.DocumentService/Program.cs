...
var serviceLogsDirectory = Path.Combine(logsDirectory, "document-service");
...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.Console()
    .WriteTo.File(
        path: Path.Combine(serviceLogsDirectory, "document-service-.txt"),
...
builder.Services.AddDbContext<DocumentDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("SmartShip.DocumentService")));
